...
public abstract class AnnotatedCallableConfigurator<T, A extends jakarta.enterprise.inject.spi.AnnotatedCallable<T>,
    ...
    public List<jakarta.enterprise.inject.spi.configurator.AnnotatedParameterConfigurator<T>> params() {
        return (List) parameters;
    }

    public Stream<jakarta.enterprise.inject.spi.configurator.AnnotatedParameterConfigurator<T>> filterParams(Predicate<jakarta.enterprise.inject.spi.AnnotatedParameter<T>> predicate) {
