...
public record Configuration(ConnectionFactory connectionFactory, Retry initialConnectionRetry) {
    ...
    public Configuration {
        ...
        if (!connectionFactory.isAutomaticRecoveryEnabled() || connectionFactory.isTopologyRecoveryEnabled()) {
            LOG.log(WARNING, "The given connection factory does not have automatic recovery enabled. "
